...
Different conventions work better for different purposes (folders and file versus programming objects). 
  ...
  -   **snake_case**: all lowercase with underscores separating words. Only use for functions and variables in R. See [@sec-objects-functions] for example R errors when including hyphens in object names.
...
+---------------------------+-------------------+-------------------------------------+
| **Code and variables**    | snake-case        | sample_id                           |
|                           |                   |                                     |
|                           |                   | toc_percent                         |
|                           |                   |                                     |
|                           |                   | pmn_mg_per_kg                       |
