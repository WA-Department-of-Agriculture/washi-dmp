...
See the example R script below, copied from the private [`soils-internal` GitHub
repository](https://github.com/WA-Department-of-Agriculture/soils-internal/blob/2f7ed5a621a7254835b3f3126acecf0c6ed72b00/R/anonymizeData.R)
(if you aren't part of the WSDA GitHub organization, this link will give you a
404 error). Note: this script does not follow the code style guide in
@sec-code-style-guide as it was written prior to this DMP.
