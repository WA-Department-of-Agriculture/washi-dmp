...
!["0O" and "1li" in Atkinson Hyperlegible.](images/atkinson-hyperlegible.png){width="100px"}
:::
...
![](images/cryo-labels.jpg){width="450px" fig-alt="Falcon tubes from a -80 °C freezer with the labels starting to peel off."}
