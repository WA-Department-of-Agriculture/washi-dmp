...
This DMP is best viewed in Google Chrome since the browser can open local file links using the [Enable local file links extension](chrome://extensions/?id=nikfmfgobenbhmocjaaboihbeocackld) that should automatically be enabled by our organization.
...
|----------------|-----------------|-----------------------|
| CoPI           | WSDA            | Dani Gelardi          |
| CoPI           | WSU             | Deirdre Griffin LaHue |
