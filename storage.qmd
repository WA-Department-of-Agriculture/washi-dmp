...
The file should then be copied over to a `working` folder for any processing or analyses. The final dataset should be saved in a separate `clean` folder, with a descriptive title. Keeping a `readme.txt` to document your processing steps is good practice, as discussed in @sec-readme.
