...
Data generated from or integrated into Climate & Conservation work can be non-digital or digital.
...
stored in formats depending on the programming language: a couple examples include Quarto (qmd) and Jupyter notebook (ipynb).
