...
information, and management data. **Readme's** and **changelogs** document what
...
alongside data files that document changes to the dataset.
...
contains two tabs (`lab-results` and `sample-locations`) that describe the attributes of each variable.
...
[Y:/NRAS/soil-health-initiative/state-of-the-soils/data-sources](Y:/NRAS/soil-health-initiative/state-of-the-soils/data-sources).

### Intake form

External data may be provided in the [External Data Intake
spreadsheet](Y:/NRAS/soil-health-initiative/state-of-the-soils/data-sources/washi-sos-external-data-intake.xlsx),
