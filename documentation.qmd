...
Crystal Lewis gave the lightning talk [*A Comparison of Packages to Generate Codebooks*](https://github.com/Cghlewis/codebook-pkg-comparison). I'd like to generate a codebook for our dataset once it lives in a database.
